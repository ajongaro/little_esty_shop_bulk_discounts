...
RSpec.describe InvoiceItem, type: :model do
  ...
  describe "class methods" do
    before(:each) do
      ...
      @bulk_discount1 = BulkDiscount.create(merchant: @m1, discount: "10%", quantity: 10)
    ...
    it 'find_discount' do
      expect(@ii_1.find_discount).to eq(@bulk_discount1)
      expect(@ii_3.find_discount).to eq(@bulk_discount3)
    end
  end
end
